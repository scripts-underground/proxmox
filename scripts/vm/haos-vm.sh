...
msg_info "Retrieving the URL for the Home Assistant OS Disk Image"
URL=https://github.com/home-assistant/operating-system/releases/download/stable/haos_ova-14.2.qcow2.xz
sleep 2
...
msg_info "Creating a Home Assistant OS VM"

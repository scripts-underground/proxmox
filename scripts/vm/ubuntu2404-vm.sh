...
var_disk="${var_disk:-7}"
VM_URL="${VM_URL:-https://cloud-images.ubuntu.com/noble/current/noble-server-cloudimg-amd64.img}"
...
function post_install_script() {
  msg_ok "Created a Ubuntu 24.04 VM ${CL}${BL}(${VM_HN})"

...
source <(curl -fsSL https://raw.githubusercontent.com/scripts-underground/proxmox/main/misc/api.func) 2>/dev/null
source <(curl -fsSL https://raw.githubusercontent.com/scripts-underground/proxmox/main/misc/vm-core.func) 2>/dev/null
source <(curl -fsSL https://raw.githubusercontent.com/scripts-underground/proxmox/main/misc/cloud-init.func) 2>/dev/null || true
load_functions

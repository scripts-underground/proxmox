...
function install_script() {
  ...
  ipfs config --json API.HTTPHeaders.Access-Control-Allow-Origin "[\"http://127.0.0.1:5001\", \"http://localhost:5001\", \"http://${LOCAL_IP}:5001\", \"https://webui.ipfs.io\"]"
...
ExecStart=/usr/local/kubo/ipfs daemon
Restart=on-failure
[Install]

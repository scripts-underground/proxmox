...
NGINXEOF
  ...
  msg_info "Creating Reitti Configuration"
...
EOF
  msg_ok "Created Reitti Configuration"
...
function post_install_script() {
  ...
  echo -e "${INFO}${YW}Default Credentials:${CL} ${BGN}admin / admin${CL}"
}
...
function update_script() {
  ...
  # Migrate v3 -> v4: Remove RabbitMQ / Photon / Spring Settings
...
PROPEOF
  ...
  # Migrate v4 -> v5: Remove Rqueue configuration
